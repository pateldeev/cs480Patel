...
struct params {
	...
	//default parameters
	params() :
			objFile("objFiles/buddha.obj"), vertexFile("shaders/vertShader.vert"), fragmentFile("shaders/fragShader.frag"), winName("PA03_Deev_Patel"), winWidth(
					1600), winHeight(1200), eyePos(0.0, 8.0, -16.0), menu(true) {
	}
};
